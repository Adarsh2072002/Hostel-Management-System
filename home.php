...
<!--Header-->
<header>
	<div class="container agile-banner_nav header-container">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">

			<a class="navbar-brand" href="home.php"><img src="web_home\images\BEC logo.png" alt="logo" > </a>
				...
				<li class="visible">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-1)" xlink:href="web_home/images/background.jpg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
